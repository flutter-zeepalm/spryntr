...
class UserTextfeild extends StatefulWidget {
  ...
  @override
  _UserTextfeildState createState() => _UserTextfeildState();
}

bool obsecureText = false;

class _UserTextfeildState extends State<UserTextfeild> {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextField(
        ...
        style: CustomTextStyle.kmedTextStyle
            .copyWith(fontWeight: CustomFontWeight.kRegularWeight),
        ...
        decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
                borderSide: BorderSide(color: CustomColor.klightgrey),
