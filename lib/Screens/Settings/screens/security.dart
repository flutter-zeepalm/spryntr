...
import 'package:spryntr/Screens/Settings/widgets/setting_dropdown.dart';
...
class Secuirty extends StatefulWidget {
  const Secuirty({
    Key? key,
  }) : super(key: key);

  @override
  State<Secuirty> createState() => _SecuirtyState();
}

var items = ['Cashier 1', 'Cashier 2', 'Cashier 3'];
String selecteddropdown = 'Cashier 1';

class _SecuirtyState extends State<Secuirty> {
  @override
                ...
                Row(
                  children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: const DecorationImage(
                                image: AssetImage(CustomAssets.settingspic),
                              )),
                        ),
                        AddCustomSpace(width: 0, height: 16.h),
                        RichText(
                    ...
                    Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const TextFeildContainer(text: "Select Name"),
                        Container(
                          height: 56.h,
                          width: 489.w,
                          decoration: BoxDecoration(
                        ...
                        const TextFeildContainer(text: "PhoneNumber"),
                        UserTextfeild(
                        ...
                        AddCustomSpace(width: 0, height: 17.h),
                        const TextFeildContainer(text: "Email"),
                        UserTextfeild(
                            ...
                            textInput: TextInputAction.next),
                        AddCustomSpace(width: 0, height: 17.h),
                        const TextFeildContainer(text: "Password"),
                        UserTextfeild(
